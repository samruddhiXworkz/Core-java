class AmazonAccontCreated{
	...
	public static boolean createUserAmazonAccount(long mobileNumber,String mail,String password, String loginPassword,String userFirstName,String userLastName){
		...
		boolean isvalidUserDetails=validUserDetails(mobileNumber,mail,password,loginPassword,userFirstName,userLastName);
		return isAmazonAccountCreated;
	}
	public static boolean validUserDetails(long mobileNumber,String mail,String password, String loginPassword,String userFirstName,String userLastName){
